...
<body ng-app="pinyougou" ng-controller="itemController" ng-init="num=1;showSku()">
            ...
            <div class="py-container">
                <div class="shortcut">
                    ...
                    <ul class="fr">
                        ...
                        <li class="f-item"><a hresku-namef="home.html" target="_blank">我的品优购</a></li>
                        <li class="f-item space"></li>
            ...
            <div class="fr itemInfo-wrap">
                ...
                <div class="clearfix choose">
                    <div id="specification" class="summary-wrap clearfix">
                        <#list customAttributeList as cusList>
                            <dl>
                                <dt>
                                    <div class="fl title">
                                        <i>${cusList.text}</i>
                        ...
                        <#list specificationList as specList>
                            <dl>
                                ...
                                <#list specList.attributeValue as item>
                                        <dd>
                                            <a href="javascript:;" ng-click="selectSpecification('${specList.attributeName}','${item}')"
                                               class="{{isSelected('${specList.attributeName}','${item}')?'selected':''}}">
                                                ${item}
                                                <span title="点击取消选择">&nbsp;</span>
                                            </a>
                                        </dd>
